...
#define module_init(x)                \
    static void module_init_##x(void) \
    {                                 \
        x();                          \
    }
#define module_exit(x)                \
    static void module_exit_##x(void) \
    {                                 \
        x();                          \
    }
...
#define dma_sync_single(a, b, c, d) \
    do                              \
    {                               \
    } while(0)
#define dma_sync_sg(a, b, c, d) \
    do                          \
    {                           \
    } while(0)
#define dma_map_sg(a, b, c, d) 0
#define dma_unmap_sg(a, b, c, d) \
    do                           \
    {                            \
    } while(0)

#define usb_create_driverfs_dev_files(a) \
    do                                   \
    {                                    \
    } while(0)
#define usb_create_driverfs_intf_files(a) \
    do                                    \
    {                                     \
    } while(0)
...
#define dev_dbg(x, f, arg...) \
    do                        \
    {                         \
    } while(0) // printk(f, ## arg)
...
#define dev_info(x, f, arg...) \
    do                         \
    {                          \
    } while(0)
#define dev_warn(x, f, arg...) \
    do                         \
    {                          \
    } while(0)
#define dev_err(x, f, arg...) \
    do                        \
    {                         \
    } while(0)
#define pr_debug(x, f, arg...) \
    do                         \
    {                          \
    } while(0)
#define usbprintk
