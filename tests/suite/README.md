...
| `xact_cue`   | XACT HLE (host audio) | XDK 5849 generated PCM banks; cue lookup, prepare, play, stop by instance/index, invalid-index rejection, and ownership teardown |
