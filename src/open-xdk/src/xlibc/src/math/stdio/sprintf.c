    ...
    while(true)
    {
        ...
        switch(c)
        {
            ...
            case '%':
                ...
                {
                    case 's':
                        index = AddString(pDest, index, count, va_arg(ap, char*));
                        break;
                    case 'd':
                        index = AddInt(pDest, index, count, va_arg(ap, int), 0);
                        break;
                    case 'x':
                        index = AddHex(pDest, index, count, va_arg(ap, int), &HexTable1[0]);
                        break;
                    case 'X':
                        index = AddHex(pDest, index, count, va_arg(ap, int), &HexTable2[0]);
                        break;
                    case 'f':
