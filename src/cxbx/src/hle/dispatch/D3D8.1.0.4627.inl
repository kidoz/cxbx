...
// _D3DDevice_DeletePixelShader@4 (XDK 4627 d3d8.lib, 32 bytes).
// Generated by tools/oovpa/gen_oovpa.py and verified exactly once in
// Turok - Evolution's retail XBE.
SOOVPA<8> IDirect3DDevice8_DeletePixelShader_1_0_4627 =
{
    0, 8, -1, 0,
    {
        { 0x00, 0x8B },
...
// ******************************************************************
// * Pushbuffer recording (generated by tools/oovpa/gen_oovpa.py from the
// * 4627 d3d8.lib; verified unique against the Turok XBE and the other
// * in-repo title/probe images). See the execute-at-record note at
// * EmuIDirect3DDevice8_BeginPushBuffer.
// ******************************************************************

// _D3DDevice_CreatePushBuffer2@8 (d3d8.lib, 144 bytes)
SOOVPA<8> D3DDevice_CreatePushBuffer2_1_0_4627 =
{
    0, 8, -1, 0,
    {
        { 0x00, 0x53 },
...
// _D3DDevice_BeginPushBuffer@4 (d3d8.lib, 112 bytes)
SOOVPA<8> D3DDevice_BeginPushBuffer_1_0_4627 =
{
    0, 8, -1, 0,
    {
        { 0x00, 0x56 },
...
// _D3DDevice_EndPushBuffer@0 (d3d8.lib, 144 bytes)
SOOVPA<8> D3DDevice_EndPushBuffer_1_0_4627 =
{
    0, 8, -1, 0,
    {
        { 0x00, 0x51 },
...
OOVPATable D3D8_1_0_4627[] =
{
    ...
    // D3DDevice_CreatePushBuffer2
    {
        (OOVPA*)&D3DDevice_CreatePushBuffer2_1_0_4627,
