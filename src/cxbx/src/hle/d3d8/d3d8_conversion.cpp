...
// *
// *   cxbx->win32->cxbxkrnl->d3d8_conversion.cpp
// *
...
CONST DWORD XTL::EmuD3DRenderStateSimpleEncoded[174] = {
    ...
    X_D3DRSSE_UNK, // 8
    0x0004037c,
    X_D3DRSSE_UNK, // 10 - D3DRS_SHADEMODE
    X_D3DRSSE_UNK,
    X_D3DRSSE_UNK, // 12
    0x0004035c,
    0x00040300, // 14 - D3DRS_ZWRITEENABLE, D3DRS_ALPHATESTENABLE
    X_D3DRSSE_UNK,
    X_D3DRSSE_UNK, // 16
    X_D3DRSSE_UNK,
    0x00040344, // 18
    0x00040348,
    X_D3DRSSE_UNK, // 20 - D3DRS_DESTBLEND
    X_D3DRSSE_UNK,
    0x00040354, // 22 - , D3DRS_ZFUNC
    0x00040340,
    0x0004033c, // 24 - D3DRS_ALPHAREF, D3DRS_ALPHAFUNC
    0x00040310,
    0x00040304, // 26 - D3DRS_DITHERENABLE, D3DRS_ALPHABLENDENABLE
    X_D3DRSSE_UNK,
    X_D3DRSSE_UNK, // 28
    X_D3DRSSE_UNK,
    X_D3DRSSE_UNK, // 30
    ...
    X_D3DRSSE_UNK, // 58
    0x00040A6c,
    X_D3DRSSE_UNK, // 60 - D3DRS_TEXTUREFACTOR
    X_D3DRSSE_UNK,
    X_D3DRSSE_UNK, // 62
    X_D3DRSSE_UNK,
    X_D3DRSSE_UNK, // 64
    ...
    X_D3DRSSE_UNK, // 166
    0x00040358,
    X_D3DRSSE_UNK, // 168 - D3DRS_COLORWRITEENABLE
    X_D3DRSSE_UNK,
    0x00040350, // 170
    X_D3DRSSE_UNK,
    X_D3DRSSE_UNK, // 172
